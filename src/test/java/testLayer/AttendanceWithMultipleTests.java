...
public class AttendanceWithMultipleTests extends BaseClass{
	...
	public void verify_login()
	{
		...
		LogHelper.info("logged in successfull");
		...
		AddStudentSubjectwiseAttendancePage addStudentSubjectwiseAttendancePage = new AddStudentSubjectwiseAttendancePage(getDriver());
	...
	//
	//	//	@Test(priority = 4, dependsOnMethods = {"verify_add_Attendance_CTA"})
	//
